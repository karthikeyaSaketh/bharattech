      ...
      <div className='my-6 w-full h-auto'>
        <div className='flex flex-col justify-center items-center'>
          ...
          <div className='flex flex-col sm:flex-row my-4 gap-4 sm:gap-12 lg:gap-32 xl:gap-64'>
            ...
            <NavLink to='/bharattech/Registration/Juniors' className='flex flex-col items-center my-4 sm:gap-4 lg:gap-6 rounded-xl w-[250px] h-[350px] sm:h-[370px] lg:w-[320px] lg:h-[460px]' style={{ boxShadow: '0px 0px 20px rgba(0,0,0, 0.25)' }}>
            ...
            <NavLink to='/bharattech/Registration/Seniors' className='flex flex-col items-center my-4 sm:gap-4 lg:gap-6 rounded-xl w-[250px] h-[360px] sm:h-[370px] lg:w-[320px] lg:h-[460px]' style={{ boxShadow: '0px 0px 20px rgba(0,0,0, 0.25)' }}>
